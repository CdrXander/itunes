angular.module('itunes').controller('mainCtrl', function($scope, itunesService){
  ...
  // is coming from the input box on index.html, head over there and check if that input 
  // box is tied to any specific model we could use.
  ...
  //Check that the above method is working by entering a name into the 
  /// input field on your web app, and then console.log the result.




  //If everything worked you should see a huge array of objects inside your console. 
  // That's great! But unfortunately that's not what ng-grid is expecting. 
  // What you need to do now is sort the data you got back.
  // This sounds like a great job for a service! 
  ...
  // we can now put the result of calling that method onto $scope.songData 
  // so that ng-grid will find it and populate the page.
